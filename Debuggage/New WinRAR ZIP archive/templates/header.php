    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <nav id="navbar" class="nav-menu navbar">
                ...
                <ul>
                    <li><a href="<?= home_url(); ?>" class="nav-link scrollto <?= is_current_url() ? 'active' : '' ?>"><i class="bx bx-home"></i>
                    ...
                    <li><a href="<?= home_url(); ?>/euros-dollars" class="nav-link scrollto <?= is_current_url('/euros-dollars') ? 'active' : '' ?>"><i class="bx bx-file-blank"></i> <span>Convertisseur</span></a></li>
